    ...
    <div className="TermsAndConditions">
      <article>
        ...
        <div>
          ...
          <p>
            <FormattedMessage
              ...
              values={{
                a: (...chunks) => (
                  <a
                    href={"http://www.GiveMeaRide.com/terms-and-conditions"}
                    target="_blank"
            ...
            <FormattedMessage
              ...
              values={{
                a: (...chunks) => (
                  <a
                    href={"http://www.GiveMeaRide.com/cookies-policy"}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    {chunks}
          ...
          <p>
            <strong>2.1.6 </strong>
            <FormattedMessage id="privacyPolicy.item6" />
          </p>
          <p>
            <strong>2.1.7 </strong>
            <FormattedMessage id="privacyPolicy.item7" />
          </p>
          <p>
            <strong>2.1.8 </strong>
            <FormattedMessage id="privacyPolicy.item8" />
          </p>
          <p>
            <strong>2.1.9 </strong>
            <FormattedMessage id="privacyPolicy.item9" />
          </p>
          <p>
            <strong>2.1.10 </strong>
            <FormattedMessage id="privacyPolicy.item10" />
          </p>
          <p>
            <strong>2.1.11 </strong>
            <FormattedMessage id="privacyPolicy.item11" />
          </p>
          <p>
            <strong>2.1.12 </strong>
            <FormattedMessage id="privacyPolicy.item12" />
          </p>
          <p>
            <strong>2.1.13 </strong>
            <FormattedMessage id="privacyPolicy.item13" />
          </p>
          <p>
            <strong>2.1.14 </strong>
            <FormattedMessage id="privacyPolicy.item14" />
          </p>
          <p>
            <strong>2.1.15 </strong>
            <FormattedMessage id="privacyPolicy.item15" />
          </p>
          <h3>
            <FormattedMessage
              id="privacyPolicy.p9"
          ...
          <p>
            <strong>2.2.1 </strong>
            <FormattedMessage id="privacyPolicy.p10" />
          </p>
          <p>
            <strong>2.2.2 </strong>
            <FormattedMessage id="privacyPolicy.p11" />
            <a href="/cookies-policy">
              <u>
                <span>
                  <FormattedMessage id="privacyPolicy.p12" />
                </span>
              </u>
            </a>
            ).
          ...
          <p>
            <strong>2.2.3 </strong>
            <FormattedMessage id="privacyPolicy.p13" />
          </p>
          <p>
            <strong>2.2.4 </strong>
            <FormattedMessage id="privacyPolicy.p14" />
          </p>
          <p>
            <strong>2.3. </strong>
            <FormattedMessage id="privacyPolicy.p15" />
          </p>
          <p>
            <strong>2.3.1 </strong>
            <FormattedMessage id="privacyPolicy.p16" />
          </p>
          <p>
            <FormattedMessage id="privacyPolicy.p17" />
          </p>
          <p>
            <strong>2.3.2 </strong>
            <FormattedMessage id="privacyPolicy.p18" />
          </p>
          <p>
            <FormattedMessage id="privacyPolicy.p19" />
          </p>
          <p>
            <strong>2.3.3 </strong>
            <FormattedMessage id="privacyPolicy.p20" />
          </p>
          <p>
            <strong>2.3.4 </strong>
            <FormattedMessage id="privacyPolicy.p21" />
          </p>
          <p>
            <FormattedMessage
