...
<p ><strong>2.1.1</strong> Información obligatoria necesaria para registrarse en el servicio que proporcionamos en nuestra Plataforma o para acceder a otros de nuestros servicios; estos datos incluyen tu nombre, correo electrónico, fecha de nacimiento, sexo, número de teléfono móvil y, cuando creas una cuenta, una contraseña. Todos estos campos son obligatorios. GimmeARide no podrá proporcionarte los servicios ofrecidos en nuestra página y app si no nos das la información necesaria o, si procede, no podrás crearte una cuenta de usuario en nuestra Plataforma;</p>
...
<p ><strong>4.2</strong> Podemos recibir y enviar información acerca de ti, incluidos tus datos personales, a otras entidades de GimmeARide o sociedades afiliadas a la misma, a los efectos estipulados en esta Política de Privacidad.</p>
...
<ul >
<li>nuestros socios comerciales que son plataformas de redes sociales y que pueden proporcionarte servicios relacionados, tales como la conexión de la información de tu perfil de GimmeARide, desde sus plataformas de redes sociales a nuestra plataforma.</li>
...
<p ><strong>4.4.7</strong> Cuando sea legalmente requerido o cuando consideremos de buena fe que sea algo razonablemente necesario para (i) responder a una reclamación contra GimmeARide, (ii) cumplir con procedimientos legales, (iii) obligar al cumplimiento de un contrato con nuestros usuarios, de acuerdo con nuestros Condiciones Generales de Uso, nuestra Política de Privacidad, nuestro Código de Buena Conducta, (iv) en el caso de emergencia que entrañe un peligro para la salud pública, muerte o daño físico a una persona (v) en el marco de una investigación o (vi) para proteger los derechos, la propiedad o la seguridad personal de GimmeARide, sus miembros u otras personas;</p>
...
<p ><strong>4.4.9</strong> Si GimmeARide o la totalidad o parte de sus activos es adquirida por un tercero, en cuyo caso los datos personales que mantenemos serán uno de los activos transferidos.</p>
...
<p>Si envías una solicitud al Delegado de Protección de Datos del Grupo (<a href="http://dataprotection@GimmeARide.com/?" target="_blank" rel="noopener noreferrer" data-saferedirecturl="https://www.google.com/url?q=http://dataprotection@GimmeARide.com/?&amp;source=gmail&amp;ust=1592983465896000&amp;usg=AFQjCNHMMCFG5QObKAgrF0h_UaypctJ46Q">dataprotection@GimmeARide.com</a>), podremos proporcionarte los detalles sobre esas garantías oportunas (por ejemplo, las cláusulas contractuales tipo emitidas por la Comisión Europea).</p>
...
<p ><strong>8.7 </strong>Para ejercer tus derechos, contacta con el Delegado de Protección de Datos del Grupo (dataprotection@GimmeARide.com).</p>
...
<p>Si tienes alguna pregunta sobre esta Política de Privacidad o si tienes alguna solicitud con respecto a tus Datos personales, puedes ponerte en contacto con nosotros mediante correo electrónico a nuestro Delegado de Protección de Datos en <a href="mailto:grupo10.soyhenry@gmail.com">dataprotection@GimmeARide.com.</a></p>
<hr />
        </div>
      </article>
    </div> 
