    ...
    return (
        <div>
            <div>
              ...
              <h3>¿Qué es Subi que te Llevo?</h3>
              <p>Es una red de personas que comparten viajes en auto entre ciudades, haciendo una división equitativa de costos entre todos los viajeros o una contribución convenida. Subi que te Llevo no es un sistema de transporte de pasajeros ni público ni privado.</p>
              ...
              <h3>¿Qué tipos de viaje puedo hacer con Subi que te Llevo?</h3>
              <p>En Subi que te Llevo podés crear o encontrar viajes a media y larga distancia, desde comunas aledañas a destinos internacionales. </p>
              ...
              <h3>¿Tienen costo los viajes en Subi que te Llevo? ¿Qué costo tiene un viaje de Subi que te Llevo?</h3>
              <p>Subi que te Llevo -al ser una red de personas que comparten viajes- sólo permite contribuciones monetarias para combustible utilizado y peajes o división equitativa de gastos entre todos los partícipes. No existe una tarifa fija ni un valor de pasaje. La contribución no puede superar el valor de una división equitativa de gastos de combustible y peajes ya que de ser así podría ser considerado como un transporte ilegal de pasajeros. <u>Subi que te Llevo es una red colaborativa, no un servicio.</u></p>


              <h3>¿Cómo se calcula la contribución para un viaje?</h3>
              <p>La contribución monetaria máxima aceptada en Subi que te Llevo es la de combustible utilizado + peajes dividido la cantidad de personas que viajan en el auto. La misma se debe definir antes del viaje, antes o durante la coordinaciòn previa. A menos que se decida hacer una división de gastos con los tickets de combustible y peaje en mano, al finalizar el mismo.En caso de que una persona pida un valor monetario que deje en evidencia que supera la máxima aceptada, será advertido por los administradores y suspendido de la plataforma hasta aceptar las reglas.En caso de reincidencia, suspendido por meses hasta llegar a una suspensiòn definitiva.</p>
              ...
              <p>Al momento de crear un viaje podés definir la privacidad del mismo y elegir quiénes serán los usuarios de Subi que te Llevo que podrán contactarse con vos. <br/>
                Hay tres tipos de visibilidad: <br/>
                “Viaje público” <br/>
                “Viaje visible para amigos de amigos” <br/>
                “Viaje visible para amigos” <br/>
                <br/>Podés crear tu lista de amigos enviando solicitudes de amistad dentro de la plataforma o vinculando tu cuenta con la de Facebook, para que la plataforma tenga en cuenta también a tus amigos de esa red social que están en Subi que te Llevo. 
              </p>
              <p>Siguiendo esto los tres tipos de viaje comprenden: </p>
              <ul>
                <li>“Viaje público” → TODOS los usuarios de Subi que te Llevo podrán ver y solicitar este viaje.</li>
                <li>“Viaje visible para amigos de amigos” →  tus amigos y sus amigos de Subi que te Llevo y Facebook (si te loggeaste con esta red social) podrán ver y solicitar este viaje.</li>
                <li>“Viaje visible para amigos” → sólo tus amigos de Subi que te Llevo y Facebook (si te loggeaste con esta red social)  que utilicen Subi que te Llevo podrán ver y solicitar este viaje.</li>
              </ul>
              ...
              <p>Si tuviste una mala experiencia con tu viaje (conductores irresponsables, falta de compromiso del pasajero, entre otros problemas) o las condiciones del mismo no se dieron tal como fueron pautadas, contá sobre tu experiencia cuando puedas calificar a la otra persona. Es por eso que es importante que mantengas la coordinación de los viajes dentro de la plataforma de Subi que te Llevo.</p>
              <p>Si la mala experiencia implica violencia por mensajes, verbal o física. También violencia vial (conducción peligrosa, uso de teléfono celular, etc). No respetar la contribución máxima o alguna otra ilegalidad. Más allá de dejar una calificación a la persona, también escribinos a Subi que te Llevo@stsrosario.org.ar o vía Mensaje Privado en nuestra página de Facebook, Instagram o Tweeter y contanos qué pasó. 
              ...
              <h3>¿Puedo Subi que te Llevo sin tener auto?</h3>
              ...
              <h3>¿Puedo usar Subi que te Llevo para empalmar con otro transporte y continuar mi viaje? (Ejemplo: para ir al Aeropuerto Internacional de Ezeiza)   </h3>
              ...
              <p>Sí, usando el buscador de viajes. En la pantalla principal de la plataforma vas a poder ingresar “Origen”, “Destino” y/o “Fecha”. Todas funcionan como opcionales ya que no es necesario completar las tres.  <br/>Ejemplo: Si querés irte un fin de semana largo de viaje pero no tenés destino definido, podés ingresar tu lugar de origen y la fecha en la que deseás salir. El buscador se encargará de mostrarte todos los viajes que salgan de ese lugar en esa fecha. Además, te mostrará viajes relacionados con fechas alternativas por si tenés planes flexibles. <br/>Te invitamos a navegar la app y ver las infinitas opciones de viajes, como sumarte a alguno con asientos libres o encontrar compañeros viajeros en la lista de pasajeros que buscan auto. 
                ...
                <p>Luego de realizar una búsqueda de viaje, al final del listado de resultados encontrarás un botón para crear una alerta con los datos de viajes que cargaste en la búsqueda.
                  ...
                  Próximamente podrás configurar las condiciones de la alerta pudiendo tener un rango de tiempo y distancia. Podés colaborar con Subi que te Llevo para que podamos incorporar estas funciones pronto <a href="https://subiquetellevo.com.ar/donar"> ---&gt; ¡Donar!</a></p>

                  <h3>¿Cómo funciona el ‘matcheador’ de viajes?</h3>
                  <p>Para ver los matchs (o coincidencias) de búsqueda con viajes publicados, tenés que ir a “mis viajes” entrar al que creaste y vas a ver las coincidencias. El “match” tiene un rango de días. Próximamente podrás configurar las condiciones de “match” pudiendo tener un rango de tiempo y distancia. Podés colaborar con Subi que te Llevo para que podamos incorporar estas funciones pront <a href="https://subiquetellevo.com.ar/donar"> ---&gt; ¡Donar!</a></p>

              <h3>¿Puedo invitar a mis amigos a Subi que te Llevo? :D</h3>
              ...
              <h3>¿Puedo crear viajes frecuentes u ocasionales para Subi que te Llevo dentro de mi ciudad?</h3>
              ...
              <h3>¿Cómo nace Subi que te Llevo? ¿Quiénes lo hacen? </h3>
              <p>Subi que te Llevo es una red de personas que comparten viajes en auto. Es un proyecto de gestión colectiva sin fines de lucro y de código libre que surge de la asociación civil STS Rosario en 2013 con el fin de aportar a un uso más racional del auto. 
                La idea es que cuando tengamos que viajar en auto porque no hay colectivo o no nos conviene por algún motivo, siempre busquemos de llenar el auto para hacer un mejor aprovechamiento de los recursos fósiles y contaminación asociada al viaje. Más allá de la motivación ambiental, también Subi que te Llevo nos parece muy importante porque ayuda a generar vínculos entre las personas, quienes muchas veces no se hubieran encontrado de otra forma. </p>

                <h3>¿Cómo puedo contribuir con Subi que te Llevo?  </h3>
                <p>¡Genial que quieras colaborar! Se puede aportar a Subi que te Llevo con tareas de voluntariado y también difusión/contactos. <a href="https://subiquetellevo.com.ar/colabora-como-colaborar">Acá podés encontrar toda la información para ayudar a que Subi que te Llevo llegue más lejos</a>.  </p>

              <p>También podés donar por única vez o mensualmente acá <a href="https://subiquetellevo.com.ar/donar"> ---&gt; ¡Donar!</a></p>

              <h3>Ante cualquier comentario, consulta o propuesta de mejora, escribinos a nuestras redes Facebook, Instagram, Twitter o <a href="mailto:subiquetellevo@grupo10.com.ar" target="_top">Subi que te Llevo@grupo10.com.ar</a>.<p></p>
