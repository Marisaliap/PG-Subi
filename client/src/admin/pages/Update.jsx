          ...
          <div className="userUpdateForm">
            <div className="userUpdateLeft">
              ...
              <div className="userUpdateItem">
                ...
                <input
                  ...
                  className="userUpdateInput"
                />
                {errorsUser.dni && <p className="errorcar">{errorsUser.dni}</p>}
              </div>
              <div className="userUpdateItem">
                <label>Age</label>
                <input
                  ...
                  className="userUpdateInput"
                />
                {errorsUser.age && <p className="errorcar">{errorsUser.age}</p>}
              </div>
              <div className="userUpdateItem">
                <label>Phone</label>
                <input
            ...
            <div className="userUpdateRight">
              <div className="userUpdateUpload">
                ...
                <img className="userUpdateImg" src={userAdmin.photo} alt="" />
                <div>
                  <input
