...
import "../../Sass/Styles/AdminRegisterForm.scss";
      ...
      <div div className="newUser">
        ...
        >
          <div>
            ...
            <div /* className="newUserItem" */  className="cadaLinea" >
              <p className="label">
          ...
          <div /* className="newUserGender" */ className="cadaLinea">
